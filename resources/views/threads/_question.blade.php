...
<div class="card" v-if="editing">
    ...
    <div class="level">
        <button class="btn btn-sm btn-default level-item" @click="editing=true" v-show="! editing">Edit</button>
        <button class="btn btn-sm btn-primary level-item" @click="update">Update</button>
        <button class="btn btn-sm btn-default level-item" @click="resetForm">Cancel</button>
        @can('update',$thread)
